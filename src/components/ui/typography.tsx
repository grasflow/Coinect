...
function H2({ className, children, ...props }: React.ComponentProps<"h2">) {
  return (
    <h2
      data-slot="h2"
      className={cn("text-xl md:text-2xl lg:text-3xl font-semibold tracking-tight", className)}
      {...props}
    >
      {children}
    </h2>
...
function H3({ className, children, ...props }: React.ComponentProps<"h3">) {
  return (
    <h3
      data-slot="h3"
      className={cn("text-lg md:text-xl lg:text-2xl font-semibold tracking-tight", className)}
      {...props}
    >
      {children}
    </h3>
